...
export const ListPlayersResponseItem = zod.object({
  ...
  supplementalTeamId: zod.number().nullish(),
  supplementalTeamName: zod.string().nullish(),
  squad: zod.string().nullish(),
  supplementalSquad: zod.string().nullish(),
  primarySpecificRole: zod.string().nullish(),
  primaryLineupStatus: zod.string().nullish(),
  supplementalSpecificRole: zod.string().nullish(),
  supplementalLineupStatus: zod.string().nullish(),
  ...
  phone: zod.string().nullish(),
  email: zod.string().nullish(),
  phoneOwnerType: zod.string().nullish(),
  parentFirstName: zod.string().nullish(),
  parentLastName: zod.string().nullish(),
  parentPhone: zod.string().nullish(),
  parentEmail: zod.string().nullish(),
  parentRelation: zod.string().nullish(),
  secondaryContactFirstName: zod.string().nullish(),
  secondaryContactLastName: zod.string().nullish(),
  secondaryContactPhone: zod.string().nullish(),
  secondaryContactEmail: zod.string().nullish(),
  secondaryContactRelation: zod.string().nullish(),
  registered: zod.boolean().nullish(),
  registrationNumber: zod.string().nullish(),
  medicalCertificateExpiry: zod.string().nullish(),
  shuttleService: zod.boolean().nullish(),
  shuttleRoute: zod.string().nullish(),
