...
export const clubsTable = pgTable("clubs", {
  ...
  backgroundLogoEnabled: integer("background_logo_enabled").notNull().default(1),
  backgroundLogoMode: text("background_logo_mode").notNull().default("large"),
  backgroundLogoOpacity: integer("background_logo_opacity").notNull().default(8),
