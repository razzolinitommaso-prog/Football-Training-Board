...
export const playersTable = pgTable("players", {
  ...
  phone: text("phone"),
  email: text("email"),
  phoneOwnerType: text("phone_owner_type").default("player"),
  parentFirstName: text("parent_first_name"),
  parentLastName: text("parent_last_name"),
  parentPhone: text("parent_phone"),
  parentEmail: text("parent_email"),
  parentRelation: text("parent_relation"),
  secondaryContactFirstName: text("secondary_contact_first_name"),
  secondaryContactLastName: text("secondary_contact_last_name"),
  secondaryContactPhone: text("secondary_contact_phone"),
  secondaryContactEmail: text("secondary_contact_email"),
  secondaryContactRelation: text("secondary_contact_relation"),
  ...
  shuttleRoute: text("shuttle_route"),
  shuttleDirection: text("shuttle_direction"),
  available: boolean("available").default(true).notNull(),
  unavailabilityReason: text("unavailability_reason"),
  expectedReturn: date("expected_return"),
  availabilityOverrideActive: boolean("availability_override_active").default(false).notNull(),
  availabilityOverrideFrom: date("availability_override_from"),
  availabilityOverrideUntil: date("availability_override_until"),
