...
export const trainingCalendarOverridesTable = pgTable("training_calendar_overrides", {
  ...
  targetTeamId: integer("target_team_id").references(() => teamsTable.id, { onDelete: "set null" }),
  targetDate: date("target_date"),
  targetStartTime: text("target_start_time"),
  targetEndTime: text("target_end_time"),
