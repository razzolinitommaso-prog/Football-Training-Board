...
export default function PlatformLoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] flex items-center justify-center px-6 pb-[calc(1.5rem+env(safe-area-inset-bottom))] pt-[calc(1.5rem+env(safe-area-inset-top))]">
