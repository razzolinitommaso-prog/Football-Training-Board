    ...
    <SidebarProvider defaultOpen={defaultSidebarOpen} style={style}>
      <div className="flex h-screen w-full bg-muted/30">
        ...
        <div className="flex flex-col flex-1 min-w-0 overflow-hidden">
          <header className="flex h-16 shrink-0 items-center justify-between px-4 sm:px-6 border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 sticky top-0 z-10">
