...
export function mapPlayersForExcel(players: any[], teams: any[]) {
  ...
  return players.map((p) => ({
    ...
    "Telefono": p.phone ?? "",
    "Email": p.email ?? "",
    "Telefono riferito a": p.phoneOwnerType === "parent" ? "Genitore" : "Giocatore",
    "Nome Genitore": p.parentFirstName ?? "",
    "Cognome Genitore": p.parentLastName ?? "",
    "Telefono Genitore": p.parentPhone ?? "",
    "Email Genitore": p.parentEmail ?? "",
    "Relazione Genitore": p.parentRelation ?? "",
    "Nome Secondo Referente": p.secondaryContactFirstName ?? "",
    "Cognome Secondo Referente": p.secondaryContactLastName ?? "",
    "Telefono Secondo Referente": p.secondaryContactPhone ?? "",
    "Email Secondo Referente": p.secondaryContactEmail ?? "",
